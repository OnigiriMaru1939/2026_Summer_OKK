...
{
	test = fileMng_.LoadImageFM("Resource/Image/Title_bg_NoLogo.png");
	testLogo = fileMng_.LoadImageFM("Resource/Image/Title_Logo.png");
}
...
void SceneTitle::Draw()
{
	...
	DrawRotaGraph(Application::SCREEN_WID / 2, Application::SCREEN_HIG / 2, 1.0f, 0.0f, testLogo->GetHandle(), true);
}